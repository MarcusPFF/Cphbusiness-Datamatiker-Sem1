...
void setup() {
  ...
  println(isClassmates(student1, student5));
  println(isClassmates(student1, student6));
  println(checkClassmates(student1, student2));
...
String checkClassmates(Student student1, Student student2) {
  if (isClassmates(student1, student2)) {
    return student1.name + " and " + student2.name + " are classmates.";
  } else {
    return student1.name + " and " + student2.name + " are not classmates.";
  }
}
